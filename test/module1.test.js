...
describe('Module 01 - Game Loop', () => {
  ...
  it('Left key @left-key', () => {
    ...
    assert(check_expr(left, 'ship', 'x', '-=', 15), 'Are you moving the ship `left` by `15` pixels?');
  ...
  it('Up key @up-key', () => {
    ...
    assert(check_expr(up, 'ship', 'y', '-=', 15), 'Are you moving the ship `up` by `15` pixels?');
  ...
  it('Right key @up-key', () => {
    ...
    assert(check_expr(right, 'ship', 'x', '+=', 15), 'Are you moving the ship `right` by `15` pixels?');
  ...
  it('Down key @down-key', () => {
    ...
    assert(check_expr(down, 'ship', 'y', '+=', 15), 'Are you moving the ship `down` by `15` pixels?');
